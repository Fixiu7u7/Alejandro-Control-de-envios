 ...
 * @author Fixiu
 */
public class ResgistrarUsuarios extends javax.swing.JFrame {

    String user;
    
    /**
     * Creates new form ResgistrarUsuarios
     */
    public ResgistrarUsuarios() {
        initComponents();
        user = Login.user;
        
        setTitle("Resgistrar nuevo usuario- Sesion de "+ user);
        setSize(630,350);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        cmb_niveles.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrador", "Cocinero", "Recepcionista" }));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 179, 120, 100));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResgistrarUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResgistrarUsuarios().setVisible(true);
            }
        });
    }
